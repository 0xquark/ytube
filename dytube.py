...
8888888P"  888  888 888  888  888 888 "88b d8P  Y8b 
        ...
        Y88b 888 888  Y88b 888 888 d88P Y8b.     
         "Y88888 888   "Y88888 88888P"   "Y8888  
                888                                 
           Y8b d88P                                 
            "Y88P"                                  
   \033[0m  \033[91m   \033[1m     }--{+} Coded By DrQuark {+}--{
   \033[0m  \033[91m  \033[1m    }----{+}  t.me/DrQuark {+}----{
   \033[0m  \033[91m    \033[1m    }--{+} thestrangequarks@protonmail.com  {+}--{
'''
menu = '''\033[0m
    {1}--Video Download
    {2}--Audio Download
